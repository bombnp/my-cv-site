  ...
  return (
    <div className="About PageInfo">
      ...
      <Container text className="Summary">
        ...
        <p>I believe that you can be good at anything, as long as you're passionate about it. I studied backend development by myself with some help from seniors from the university. With that, I developed APIs for <a target="_blank" rel="noopener noreferrer" href="https://projectstack.now.sh/">projectstack.now.sh</a>. </p>
